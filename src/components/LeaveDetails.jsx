  ...
  return (
    <div className="flex p-5 w-[35%] h-full ">
      <div className=" flex flex-col p-5 w-full h-full gap-5 ">
        ...
        <div className=" w-[75%] h-[5.5rem] border rounded-md  px-3 py-2 flex flex-col items-start justify-center ">
        ...
        <div className=" w-[75%] h-[5.5rem] border rounded-md  px-3 py-2 flex flex-col items-start justify-center  ">
          <p className="py-2 font-semibold text-[#99A0B0]">Optional Holiday</p>
