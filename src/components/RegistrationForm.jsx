            ...
            <div className='box md:max-h-[600px] overflow-y-auto relative top-1 flex flex-col items-center'>
                <div className='mt-6 min-w-[400px]'>
                    <form onSubmit={handleSubmit} className='grid grid-cols-2 gap-3'>
                        <label htmlFor='emp_id' className='font-serif ml-2' type="number" required>Employee Id</label>
                        ...
                        <label htmlFor='date_of_joining' className='font-serif ml-2' type="date" required>Date of Joining</label>
                        ...
                        <label htmlFor='emp_name' className='font-serif ml-2'>Employee Name</label>
                        ...
                        <label htmlFor='gender' className='font-serif ml-2'>Gender</label>
                        ...
                        <label htmlFor='contact_number' className='font-serif ml-2'>Contact No</label>
                        ...
                        <label htmlFor='work_email' className='font-serif ml-2'>Work Email</label>
                        ...
                        <label htmlFor='work_location' className='font-serif ml-2'>Location</label>
                        ...
                        <label htmlFor='designation' className='font-serif ml-2'>Designation</label>
                        ...
                        <label htmlFor='password' className='font-serif ml-2'>Password</label>
                        ...
                        <label htmlFor='active_status' className='font-serif ml-2'>Employee Status</label>
