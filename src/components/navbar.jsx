        ...
        <div className="flex items-center justify-center gap-[5px]">
          ...
          <div className="flex flex-col">
            <p className="text-[16px] font-semibold text-[#1F2937]">
              {user.user_name ? capitalizeWords(user.user_name) : "user name"}
            </p>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger style={{ outline: 0 }}>
            <div className="logo h-[5px] w-[5px] p-2 relative object-contain">
              <Image
                src="/imgs/drop-down.svg"
                alt="menu"
                layout="fill"
                objectFit="contain"
                className="h-[5px] object-contain text-[#9CA3AF]"
              />
            </div>
          </DropdownMenuTrigger>
          <DropdownMenuContent>
            <DropdownMenuItem>
              {user.work_email ? user.work_email : "Work Mail"}
            </DropdownMenuItem>
